...
<html>
  ...
  <body>
    ...
    <b>Start: </b>
    <select id="start">
      <option value="spandau, berlin, de">Spandu</option>
    ...
    <select id="end">
      ...
      <option value="Brehmestrasse 51, Berlin, DE">brehmU.</option>
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBIaHbCJHko4ThhoZ2UWKEj4sVV6VZnOeA&callback=initMap">
    </script>
  </body>
</html>