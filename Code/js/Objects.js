...
var def_locations = ["./home_inconst.php", "./login.php", "./signup.php", "./profile.php", "./content.php", "./posting.php", "/home_inconst.php"];
...
var var_def_sections = ["home", "food", "housing", "medical", "legal & documents", "study", "jobs", "volunteers", "orgs."];
