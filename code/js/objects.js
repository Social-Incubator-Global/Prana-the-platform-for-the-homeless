...
// [0]:language select combobox,
// [1]: loads filters for side column,
// [2]: logo load,
// [3]: back and front buttons,
// [4]: emergency button,
// [5]: search box,
// [6]: top menu categories
var code_snippets = [
    ...
    // 1
    '<!--<div id="filter_container">--><div id="filter_type_text"><script>dl(15);</script>:</div><br><center><script>document.write(filter_controls[0]);</script></center><br><br><br><br><script>document.write(filter_controls[1]);</script><br><br><script>document.write(filter_controls[2]);</script><br><br><div id="allows_of_venue_text"><script>dl(106);</script>:</div><br><br><script>document.write(filter_controls[3]);</script><br><br><div id="filter_distance_text"><script>dl(42);</script>:<br></div><br><br><center><select id="fil_area" method="post" name="fil_area" onChange="javascript: var ndx=document.getElementById(\'fil_area\').selectedIndex; set_local(\'area\', ndx); redirect_ajax(0);//redirect(\'content\', home_type, ndx); " style="border: 1px solid rgb(255, 127, 36); width: 78%; height: 33px; background-color: rgb(220,220,220); color: black; opacity: 0.8;"></select><script>var index = 0;for (index = 0; index <def_areas_berlin.length; ++index) {var select = document.getElementById("fil_area"); select.options[select.options.length] = new Option(def_areas_berlin[index],def_areas_berlin[index]);}</script></center><div id="by_organ"><br><br><div id="by_organ_text"><script>dl(46);</script>:<br></div><br><br><center><div id="by_org_filter"><center><select id="org_drop" name="org_drop" onChange="javascript: var ndx=document.getElementById(\'org_drop\').selectedIndex;localStorage.setItem(\'organization\', ndx); refresh_localstorage(); redirect_ajax(0);//redirect(\'content\', home_type, area);" style="border: 1px solid rgb(255, 127, 36); width: 78%; height: 33px; background-color: rgb(220,220,220); color: black; opacity: 0.8;"></select><br><br><script>var index = 0;for (index = 0; index < def_organizations.length; ++index) {var select = document.getElementById("org_drop");select.options[select.options.length] = new Option(def_organizations[index],def_organizations[index]);}</script></center></div></div></center></div></center><!--</div>-->',

    // 2
    '<form id="src_bx_cont"><input type="text" value="'+def_lang[18]+'" name="src_bx" style="width: 190px; height: 33px; float: left; margin-right: 34px;"><input type="button" value="->" id="src_bx_bttn" style="width: 35px; height: 33px;"></form>',

    /*3 Prana logo*/
    '<a href="javascript:redirect(\'home\');"><div id="logo"><img src="{{DOC_ROOT}}/assets/images/logo/prana_logo.png" width="100%"></div></a><br>',

    /*4 Emergency button*/
    '<div id=\'emergency_button_div\'><form><input id=\'emergency_call\' src=\'{{DOC_ROOT}}/assets/images/prn_ico/call.png\' style=\'float: left; background-color: red;\' type=\'image\' onclick=\'javascript:show_drop_down();\'><input class=\'emergency_button\' id=\'emergency_button\' type=\'button\' style=\'background-color:red; height:30px;\' onclick=\'javascript:show_drop_down();\' value=\'Emergency\'></input></form></div> <div><div id="myDropdown" style=\'color:black; font-family:Arial; font-size:14px;\' class="dropdown-content">\n\<div style=\'background-color:rgb(9, 103, 126);\'><center><br><img src=\'{{DOC_ROOT}}/assets/images/icons/icon_health1.png\' height=\'100px\' width=\'100px\'/><br><br></center></div><div style=\'background-color:red; color:white;\'><br><div style=\'margin-left:12px; margin-right:12px;\'>At the moment we do not provide direct calls to any of the listed emergency services, below is a list of numbers you may call using a public or private phone:</div><br></div><br><a id="artzmob_cari_drop_content" href="#">Artzmobil Caritas:<br>Tel: -/-<br>Address: -/-<input style=\'float: right; height:19px;\' type=\'image\' src=\'{{DOC_ROOT}}/assets/images/prn_ico/led_icons/marker.png\'></input><input style=\'float: right; height: 30px;\' type=\'button\' value=\'View in map\'></input></a><a id="pol_drop_content" href="#">Polizei für die obdachlosen:<br>Tel: -/-<br>Address: -/-<input style=\'float: right; height:19px;\' type=\'image\' src=\'{{DOC_ROOT}}/assets/images/prn_ico/led_icons/marker.png\'></input><input style=\'float: right;\' type=\'button\' value=\'View in map\'></input></a></div></div>',

    /*5 uaucnt*/
    '<div id="uacnt_alternative"><form id="src_bx_cont"><input type="text" id="search_bx" style="width: 77%; height: 33px; float: left;"><input type="button" value="->" id="src_bx_bttn" style="width: 35px; height: 33px;"></form></div><script>get_item("search_bx").value=dl_r(18);</script>',

    /*6 top banner home_type picker*/
    '<div id="sel_home_type"><div id="img_sel" style="background-color: rgba(0, 93, 116, 1); float:left; margin-left:2%; height: 100%; width:40px;"><img id="home_type_button_image" src="{{DOC_ROOT}}/assets/images/icons/icon_housing.png" class="home_type_button_image" onclick="javascript:show_drop_down();" style="float:left; margin-left:12%; margin-top:17%; height: 30px; width:30px;"/></div><input class="home_type_button_text" id="home_type_button_text" style="float:left; margin-left:0%; height:100%; background-color: rgba(29, 123, 146, 1);" type="button" value="-/-" onclick="javascript:show_drop_down();"></input><div id="home_type_down_select" class="home_type_down_select" onclick="javascript:show_drop_down();" style="float:left; margin-left:0%; height:100%; background-color: rgba(29, 123, 146, 1);"><img class="home_type_button_drop" id="home_type_button_drop" src="{{DOC_ROOT}}/assets/images/prn_ico/white_down.png" style="float:left; margin-top:18px;"/></div><div id="myDropdown" class="dropdown-content"><a id="food_drop_content" href="#"></a><a id="housing_drop_content" href="#"></a><a id="medical_drop_content" href="#"></a><a id="legal_drop_content" href="#"></a><a id="study_drop_content" href="#"></a><a id="jobs_drop_content" href="#"></a></div></div><script>change_hometype_select(true); set_hometype_select_menu();</script>',

    /*7 search topbar*/
    '<center><div id="sel_home_type"><input onclick="javscript:val=document.getElementById(\'src_bx\').value;if(val==\'Search Prana\'){console.log(\''+dl_r(18)+'\');remove_value(\'src_bx\');}" class="home_type_button_text" id="src_bx" style="float:left; margin-left:0%; width:50%; height:70%; border-radius:0px; border: 1px solid rgb(255, 127, 36);" type="text"></input><select id="src_in_top"></select></select><input type="button" value=">" onclick="javascipt:val=document.getElementById(\'src_bx\').value; redirect(\'search\');" name="src_bx_top" id="src_bx_top"></div></center><script>get_item("src_bx").value=dl_r(18); fill_search_type("src_in_top");</script>'
];
