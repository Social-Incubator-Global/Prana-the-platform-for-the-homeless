...
<html>
<title>Prana: SQL test</title>
<body>
<?php echo("V1.0 SQL test:\n");?>
<hr>
<?php 
...
$dbname = 'prna_usrs';
$num = '0';
$link = mysql_connect($hostname, $username, $password, $dbname) or die("Unable to connect to the specific host.\n[END]\n".mysql_error());

echo("Connected.\n");
echo("Attempting select statement...\n");
