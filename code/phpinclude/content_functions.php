...
function search()
{
    ...
    if(strtolower($URLfilter_result[3]) == "all")
    {
        ...
        process_single_search($result2, $URLfilter_result, '../Assets/Images/icons/icon_food.png');
        /*echo("<div class='results_titles'><img style='margin-top:-3%' width='30px' src='../Assets/Images/icons/Icon_health.png'/><div style='float:left; margin-left:2%;'>In Medical:</div></div>");*/
        process_single_search($result3, $URLfilter_result, '../Assets/Images/icons/Icon_health.png');
    }
    else
    {
...
function process_single_search($result, $URLfilter_result, $ico_path)
{
...
function load_content_boxes($query__)
{
   ...
   while($row = $result->fetch_assoc())
   {
    ...
    $echo_1 = $echo_1."<script>AJAX_SUCCESS_call_exiting_function(1);</script>";
    echo($echo_1);
