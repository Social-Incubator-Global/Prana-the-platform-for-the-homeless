<nav class="navbar navbar-toggleable-md navbar-light bg-primary" id="main-nav">
  <div class="mr-auto" id='emergency_button_div'>
    <formx>
      <input id='emergency_call' src='http://local.prana.com/assets/images/prn_ico/call.png' style='background-color: red;' type='image' onclick='javascript:show_drop_down();'>
